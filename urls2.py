...
def get_all_website_links(url):
    ...
    with open("product_data.csv", "a") as csv_file:
        ...
        writer.writerow(['Producto', 'Precio', 'Imagen','Talla','Disponibilidad'])
        for a_tag in soup.findAll("a"):
            ...
            if '/products/' in href:
                ...
                image=soup.find('img',{'class':'lazyloaded'})
                clean = re.compile('<.*?>')
                price= str(price)
                ...
                try:
                    ...
                    for i in res:
                            ...
                            writer.writerow([name, price, image,list(variables.values()),availability_html])
                except KeyError:
...
if __name__ == "__main__":
    ...
    urls = ['https://es.walkersappeal.com/collections/']
    max_urls=100
